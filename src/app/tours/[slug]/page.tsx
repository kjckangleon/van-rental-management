        ...
        <div className="absolute bottom-0 left-0 right-0 p-8">
          <div className="container mx-auto">
            <div className="text-white max-w-3xl">
              ...
              <p className="text-lg md:text-xl text-white/90">{tour.summary}</p>
            </div>
          </div>
        </div>
      </div>
          ...
          <div className="lg:col-span-1">
            <div className="sticky top-8">
              ...
              <div className="bg-gradient-to-br from-primary-600 to-primary-800 text-white rounded-xl p-6">
                ...
                <p className="text-white/90 mb-4">Our friendly team is here to help you plan your perfect Cebu adventure.</p>
